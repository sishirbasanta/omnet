#
# OMNeT++/OMNEST Makefile for final_task
#
# This file was generated with the command:
#  opp_makemake -f --deep -O out -KINET_PROJ=../inet-master/inet-master -DINET_IMPORT -I. -I$$\(INET_PROJ\)/src -L$$\(INET_PROJ\)/src -lINET$$\(D\)
#

# Name of target to be created (-o option)
TARGET = final_task$(D)$(EXE_SUFFIX)
TARGET_DIR = .
...
INET_PROJ=../inet-master/inet-master
